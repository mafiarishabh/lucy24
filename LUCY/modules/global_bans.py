...
import LUCY.modules.sql.global_bans_sql as sql
from LUCY.modules.sql.users_sql import get_user_com_chats
from LUCY import (
    DEV_USERS,
    EVENT_LOGS,
    OWNER_ID,
...
from LUCY.modules.helper_funcs.misc import send_to_list
